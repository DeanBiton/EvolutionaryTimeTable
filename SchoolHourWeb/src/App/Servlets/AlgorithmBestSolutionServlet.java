...
@WebServlet({"/Algorithm/algorithmBestSolution"})
public class AlgorithmBestSolutionServlet  extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DTOTupleGroupWithFitnessDetails bestSolution = manager.getBestSolution();
