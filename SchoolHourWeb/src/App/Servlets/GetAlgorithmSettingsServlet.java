...
@WebServlet({"/Algorithm/getSettings"})
public class GetAlgorithmSettingsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DTOEvolutionaryAlgorithmSettings settings = manager.getDataAndAlgorithmSettings().getDtoEvolutionaryAlgorithmSettings();
